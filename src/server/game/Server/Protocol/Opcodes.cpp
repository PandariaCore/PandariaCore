...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
    ...
    DEFINE_OPCODE_HANDLER(SMSG_AE_LOOT_TARGETS,                    0x0C32, STATUS_UNHANDLED); // 5.4.8 18414 # - new
    DEFINE_OPCODE_HANDLER(SMSG_AE_LOOT_TARGET_ACK,                 0x1941, STATUS_UNHANDLED); // 5.4.8 18414 # - new
    ...
    DEFINE_OPCODE_HANDLER(SMSG_LOOT_RELEASE_ALL,                   0x0E2B, STATUS_UNHANDLED); // 5.4.8 18414 # - new
