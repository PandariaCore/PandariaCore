...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_UPD_CHAR_PET_SPEC_GROUPS,
    CHAR_UPD_CHAR_PET_SPEC_COUNT,
    CHAR_UPD_CHAR_PET_ACTIVE_SPEC_GROUP,
    CHAR_INS_PET,
    ...
    CHAR_SEL_BLACK_MARKET_AUCTIONS,
    CHAR_INS_BLACK_MARKET_AUCTION,
    CHAR_DEL_BLACK_MARKET_AUCTION,
    CHAR_UPD_BLACK_MARKET_AUCTION,
