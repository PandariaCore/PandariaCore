...
void WorldDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(WORLD_SEL_BLACK_MARKET_TEMPLATE, "SELECT Id, MarketId, SellerNPCEntry, ItemEntry, Quantity, MinBid, Duration, Chance FROM black_market_template", CONNECTION_SYNCH);
    // 0: uint8
